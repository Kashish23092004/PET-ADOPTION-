      ...
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-black bg-opacity-60 duration-300  transition-all ease-in-out" : ""}`}>
        <div className="navbar text-white">
          ...
          <div className="navbar-end">
            ...
            <label className="swap swap-rotate mx-10">
  ...
  <svg
    ...
    <path
      d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z" />
            ...
            <button className="btn btn-outline btn-sm hover:bg-white hover:text-black transition-all duration-300">
              Login
            </button>
          </div>
          ...
          <div className="dropdown lg:hidden">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-black bg-opacity-80 text-white rounded-box w-52">
              {navItems}
            </ul>
          </div>
        </div>
